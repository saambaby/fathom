...
5. Outstanding: INV-07 attestation not hardcoded at the point of execution (#139); the
   real-OANDA-data fixture (#143).
...
- [ ] #139 — INV-07 attestation moved off the execution point; go-live runbook deadlock removed.
- [ ] #143 — real-OANDA-data fixture (**blocked on human:** needs an OANDA token or a candle-db export).
- [ ] `/halfcycle:cross-spec-audit` re-run — 7 spec amendments landed with their fixes.
